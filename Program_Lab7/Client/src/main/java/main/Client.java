...
public class Client {
    ...
    public static void main(String[] args) throws IOException{
        ...
        while (true) {
            ...
            UserChecked userChecked = new UserChecked(clientSocket, IPAddress, SERVICE_PORT);
            user = userChecked.authorization();
                    ...
                    if (!sentence.equals("")) {
                        ...
                        switch (cm_split[0]) {
                            ...
                            case "replace_if_greater":
                                sendingDataBuffer = serialize(new NoName(sentence, createLab(), user));
                                break;
                            default:
                                sendingDataBuffer = serialize(new NoName(sentence, user));
                        }
